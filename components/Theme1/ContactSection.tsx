                ...
                <div className="grid md:flex gap-x-6 gap-y-6 md:gap-y-0">
                    <div className="space-y-6 border border-gray-300 rounded-xl py-10 px-8 md:w-1/3 w-full">
                        <div className="space-y-2">
                            <span className="w-[20px] h-[20px] text-white"><RiMapPinLine size={20}></RiMapPinLine></span>
                            <Heading className="text-xl text-gray-400">My Address:</Heading>
                            <Paragraph className="text-white">Khulna, Bangladesh</Paragraph>
                        </div>

                        <div className="space-y-2">
                            <span className="w-[20px] h-[20px] text-white"><FiPhone size={20}></FiPhone></span>
                            <Heading className="text-xl text-gray-600">Contact number:</Heading>
                            <h1 className="text-xl text-gray-400"></h1>
                            <Paragraph className="text-white">+8801761043883</Paragraph>
                        </div>

                        <div className="space-y-2">
                            <span className="w-[20px] h-[20px] text-white"><CiMail size={20}></CiMail></span>
                            <Heading className="text-xl text-gray-400">Email us:</Heading>
                            <Paragraph className="text-white">shakidul31@gmail.com</Paragraph>
                        </div>
                    </div>
                    ...
                    <div className="border border-gray-300 rounded-xl py-10 px-8 md:w-2/3 w-full space-y-6">
                        <div className="grid md:flex items-center gap-x-4 w-full gap-y-4 md:gap-y-0">
                            <div className="w-full">
                                ...
                                <input onChange={(e) => setClientName(e.target.value)}
                                    type="text"
                                    className="w-full rounded-lg bg-gray-400 focus:outline-none focus:ring-0 border-gray-300 focus:bg-white text-black"
                        ...
                        <div>
                            ...
                            <textarea onChange={(e) => setClientMessage(e.target.value)}
                                className="rounded-lg bg-gray-400 focus:outline-none focus:ring-0 border-gray-300 focus:bg-white text-black w-full h-[123px]"
